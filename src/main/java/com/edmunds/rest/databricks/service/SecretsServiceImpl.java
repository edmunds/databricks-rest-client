...
import com.edmunds.rest.databricks.DTO.secrets.ACLSecretsDTO;
...
import com.edmunds.rest.databricks.DTO.secrets.SecretScopesDTO;
import com.edmunds.rest.databricks.DTO.secrets.SecretsDTO;
...
public class SecretsServiceImpl extends DatabricksService implements SecretsService {
  ...
  public ACLSecretDTO getSecretACL(String scope, String principal) throws IOException, DatabricksRestException {
    byte[] response = client.performQuery(
            RequestMethod.GET, ACL_API_GET_ENDPOINT + "?scope=" + scope + "&principal=" + principal
    );
