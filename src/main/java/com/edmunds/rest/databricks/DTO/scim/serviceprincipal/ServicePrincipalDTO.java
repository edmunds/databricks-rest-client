...
public class ServicePrincipalDTO {
    ...
    private List<ServicePrincipalInnerMappingDTO> groups;

    @JsonProperty("entitlements")
    private List<ServicePrincipalInnerMappingDTO> entitlements = new ArrayList<>();

    public ServicePrincipalDTO(String applicationId, String displayName, List<ServicePrincipalInnerMappingDTO> groups) {
